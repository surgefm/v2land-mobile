...
public class AppConstants {
  ...
  public static final String RELEASE_CHANNEL = "ios-prod-0.1.8";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@v2land/v2land-mobile", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40v2land%2Fv2land-mobile%2F0.1.8%2F04b6319dad3f602bef30a2f78f1216e6-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
