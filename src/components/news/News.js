...
import { paddings, pageStyle, paddingConstants, colors, fontSizes } from '../../styles';

const News = ({ news, onButtonPress = () => {} }) => !news || (
  <ScrollView style={[pageStyle.default, styles.topPadding]}>
    <View style={[paddings.interval, styles.newsSubtitle]}>
      <Subtitle style={styles.theme}>{getTimeString(news.time) + ' / '}</Subtitle>
